        ...
        <Card>
          <CardBody style={{textAlign: 'left'}}>
            ...
            <section name="contacts">
              ...
              <div>
                {curriculoData.contacts.cellphone.map((cellphone, i) => <div>
                  <strong>Cellphone {i + 1}: </strong> { cellphone.number } 
                </div>)}
              </div>

              <div>
                { curriculoData.contacts.social.map(social => <div>
            ...
            <section name="profissionalExperience">
              ...
              { curriculoData.work.profissionalExperience.map(experience => <div style={{marginBottom: 30}}>
                <div>
                  <strong>
                ...
                <div>
                  <ul>
                  { experience.experienceTopics.map(topic => <li>{ topic }</li>)}
                  </ul>
                </div>
